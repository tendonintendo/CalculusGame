...
export default function HeartGame() {
  ...
  const handleSubmit = () => {
    if (Object.values(isValid).every(Boolean)) {
      ...
      alert("still wrong. use the hints!");
    }
  };
  ...
  return (
    <div>
      ...
      (window.location.href = "/Congratulations.html")
        ...
        <div>
          <h1>submit 2 check ur answers</h1>
          <div className="input-container" style={{ display: "flex", alignItems: "center", marginBottom: "10px" }}>
            ...
            />
            <button onClick={() => alert("use wolfram alpha")} style={{ marginLeft: "10px" }}>?</button>
          </div>
          <div className="input-container" style={{ display: "flex", alignItems: "center", marginBottom: "10px" }}>
            <input
              value={gx}
            ...
            />
            <button onClick={() => alert("change one of the + signs to a -.")} style={{ marginLeft: "10px" }}>?</button>
          </div>
          <div className="input-container" style={{ display: "flex", alignItems: "center", marginBottom: "10px" }}>
            <input
              value={hx}
